...
namespace DotnetRss.Core
{
    ...
    public class LiteDBDatabaseContext : IDatabaseContext
    {
        ...
        /// </summary>
        public ILiteCollection<FeedListItem> FeedListItems => this.db?.GetCollection<FeedListItem>(FeedsCollection) ?? throw new NullReferenceException(nameof(this.db));

        /// <summary>
        /// Gets the Feed Items.
        /// </summary>
        public ILiteCollection<FeedItem> FeedItems => this.db?.GetCollection<FeedItem>(FeedItemsCollection) ?? throw new NullReferenceException(nameof(this.db));
